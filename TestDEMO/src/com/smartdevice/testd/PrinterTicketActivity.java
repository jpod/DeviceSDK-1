...
public class PrinterTicketActivity extends Activity {
	...
	//循环打印标志
	private boolean loopPrintFlag = false;
	...
	protected void onCreate(Bundle savedInstanceState) {
				...
				public void onClick(View v) {
					...
					if (message.length() > 0) {
						btMap = BarcodeCreater
								.creatBarcode(PrinterTicketActivity.this, message, 618,322, false, 1);
		...
		autoprint_Thread = new Thread() {
			public void run() {
				Bitmap mBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.zkc);
				Bitmap myBitmap = resizeImage(mBitmap, 240, 80);
				btnBarCode.performClick();
				while (isPrint) {
					if (checkBoxAuto.isChecked()) {
						try {
//							String message = et_input.getText().toString();
//							printerClass.printText(message + message + message
//									+ message + "\r\n\r\n\r\n\r\n");
							printerClass.write(PrinterClass.CMD_ALIGN_MIDDLE);
							printerClass.printImage(myBitmap);
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("H7UJ787-JU78UU6-JJ785J6-J876K76");
							printerClass.write(new byte[] { 0x0A});
							printerClass.write(PrinterClass.CMD_FONTSIZE_DOUBLE);
							printerClass.printText("Quick Lotto (5/11)");
							printerClass.write(PrinterClass.CMD_FONTSIZE_NORMAL);
							printerClass.write(new byte[] { 0x0A});
							printerClass.write(PrinterClass.CMD_ALIGN_LEFT);
							printerClass.printText("Terminal No: 85010002    SN:1");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("Draw No: 20160503011");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("Sales Time 03/05/2016-09:27:55");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("--------------------------------------------");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("Option3");
							printerClass.write(new byte[] { 0x0A});
							printerClass.write(PrinterClass.CMD_FONTSIZE_DOUBLE);
							printerClass.printText("A. 02 06 08 ￥200");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("B. 02 06 08 ￥200");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("C. 02 06 08 ￥200");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("D. 02 06 08 ￥200");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("E. 02 06 08 ￥200");
							printerClass.write(new byte[] { 0x0A});
							printerClass.write(PrinterClass.CMD_FONTSIZE_NORMAL);
							printerClass.printText("--------------------------------------------");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("Total Price: ￥1000");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("............................................");
							printerClass.write(new byte[] { 0x0A});
							printerClass.write(PrinterClass.CMD_FONTSIZE_DOUBLE_HIGH);
							printerClass.write(PrinterClass.CMD_ALIGN_MIDDLE);
							printerClass.printText("I AM NOT UNDER 18 YEARS");
							printerClass.write(new byte[] { 0x0A});
							printerClass.write(PrinterClass.CMD_FONTSIZE_NORMAL);
							printerClass.printText("............................................");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printText("HYHR6666-YHYH6666-T6G5Y6T5-H775G455");
							printerClass.write(new byte[] { 0x0A});
							printerClass.printImage(btMap);
							printerClass.printText("\r\n\r\n\r\n\r\n");
							...
							textView_msg.post(new Runnable() {								
								@Override
								public void run() {
